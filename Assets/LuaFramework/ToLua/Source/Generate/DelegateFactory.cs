...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(LuaFramework.EventTriggerListener.PointerEventDelegate), LuaFramework_EventTriggerListener_PointerEventDelegate);
		dict.Add(typeof(LuaFramework.EventTriggerListener.BaseEventDelegate), LuaFramework_EventTriggerListener_BaseEventDelegate);
		dict.Add(typeof(LuaFramework.EventTriggerListener.AxisEventDelegate), LuaFramework_EventTriggerListener_AxisEventDelegate);
		...
		dict.Add(typeof(TimerCallBack), TimerCallBack);
		dict.Add(typeof(TimerOverCall), TimerOverCall);
	}
	...
	class LuaFramework_EventTriggerListener_PointerEventDelegate_Event : LuaDelegate
	{
		public LuaFramework_EventTriggerListener_PointerEventDelegate_Event(LuaFunction func) : base(func) { }
		public LuaFramework_EventTriggerListener_PointerEventDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate LuaFramework_EventTriggerListener_PointerEventDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			LuaFramework.EventTriggerListener.PointerEventDelegate fn = delegate(UnityEngine.GameObject param0, UnityEngine.EventSystems.PointerEventData param1) { };
			return fn;
		}

		if(!flag)
		{
			LuaFramework_EventTriggerListener_PointerEventDelegate_Event target = new LuaFramework_EventTriggerListener_PointerEventDelegate_Event(func);
			LuaFramework.EventTriggerListener.PointerEventDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			LuaFramework_EventTriggerListener_PointerEventDelegate_Event target = new LuaFramework_EventTriggerListener_PointerEventDelegate_Event(func, self);
			LuaFramework.EventTriggerListener.PointerEventDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	class LuaFramework_EventTriggerListener_BaseEventDelegate_Event : LuaDelegate
	{
		public LuaFramework_EventTriggerListener_BaseEventDelegate_Event(LuaFunction func) : base(func) { }
		public LuaFramework_EventTriggerListener_BaseEventDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate LuaFramework_EventTriggerListener_BaseEventDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			LuaFramework.EventTriggerListener.BaseEventDelegate fn = delegate(UnityEngine.GameObject param0, UnityEngine.EventSystems.BaseEventData param1) { };
			return fn;
		}

		if(!flag)
		{
			LuaFramework_EventTriggerListener_BaseEventDelegate_Event target = new LuaFramework_EventTriggerListener_BaseEventDelegate_Event(func);
			LuaFramework.EventTriggerListener.BaseEventDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			LuaFramework_EventTriggerListener_BaseEventDelegate_Event target = new LuaFramework_EventTriggerListener_BaseEventDelegate_Event(func, self);
			LuaFramework.EventTriggerListener.BaseEventDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	class LuaFramework_EventTriggerListener_AxisEventDelegate_Event : LuaDelegate
	{
		public LuaFramework_EventTriggerListener_AxisEventDelegate_Event(LuaFunction func) : base(func) { }
		public LuaFramework_EventTriggerListener_AxisEventDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate LuaFramework_EventTriggerListener_AxisEventDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			LuaFramework.EventTriggerListener.AxisEventDelegate fn = delegate(UnityEngine.GameObject param0, UnityEngine.EventSystems.AxisEventData param1) { };
			return fn;
		}

		if(!flag)
		{
			LuaFramework_EventTriggerListener_AxisEventDelegate_Event target = new LuaFramework_EventTriggerListener_AxisEventDelegate_Event(func);
			LuaFramework.EventTriggerListener.AxisEventDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			LuaFramework_EventTriggerListener_AxisEventDelegate_Event target = new LuaFramework_EventTriggerListener_AxisEventDelegate_Event(func, self);
			LuaFramework.EventTriggerListener.AxisEventDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
	...
	class TimerCallBack_Event : LuaDelegate
	{
		public TimerCallBack_Event(LuaFunction func) : base(func) { }
		public TimerCallBack_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate TimerCallBack(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			TimerCallBack fn = delegate(float param0) { };
			return fn;
		}

		if(!flag)
		{
			TimerCallBack_Event target = new TimerCallBack_Event(func);
			TimerCallBack d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			TimerCallBack_Event target = new TimerCallBack_Event(func, self);
			TimerCallBack d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	class TimerOverCall_Event : LuaDelegate
	{
		public TimerOverCall_Event(LuaFunction func) : base(func) { }
		public TimerOverCall_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate TimerOverCall(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			TimerOverCall fn = delegate(float param0) { };
			return fn;
		}

		if(!flag)
		{
			TimerOverCall_Event target = new TimerOverCall_Event(func);
			TimerOverCall d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			TimerOverCall_Event target = new TimerOverCall_Event(func, self);
			TimerOverCall d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
