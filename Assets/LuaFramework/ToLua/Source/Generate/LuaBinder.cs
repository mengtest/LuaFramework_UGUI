...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		MTimerManagerWrap.Register(L);
		ViewWrap.Register(L);
		BaseWrap.Register(L);
		ManagerWrap.Register(L);
		Singleton_MTimerManagerWrap.Register(L);
		L.RegFunction("TimerCallBack", TimerCallBack);
		L.RegFunction("TimerOverCall", TimerOverCall);
		...
		System_StringSplitOptionsWrap.Register(L);
	...
	static int TimerCallBack(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(TimerCallBack), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(TimerCallBack), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int TimerOverCall(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(TimerOverCall), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(TimerOverCall), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	static int DG_Tweening_TweenCallback_float(IntPtr L)
	{
		try
		{
			...
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(DG.Tweening.TweenCallback<float>), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	static int DG_Tweening_EaseFunction(IntPtr L)
	{
		try
		{
			...
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(DG.Tweening.EaseFunction), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	static int DG_Tweening_TweenCallback_int(IntPtr L)
	{
		try
		{
			...
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(DG.Tweening.TweenCallback<int>), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
